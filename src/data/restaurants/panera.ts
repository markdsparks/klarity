...
export const PANERA_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    // Bare "broccoli cheddar soup" alias is shared with the cup-size entry
    // below so a generic search surfaces both sizes as a browsable list,
    // per spec 004's search design (most-specific alias for size-scoped
    // queries, shared alias for the size-agnostic one).
    aliases: ['broccoli cheddar soup', 'broccoli cheddar', 'broccoli cheese soup', 'bowl of broccoli cheddar', 'large broccoli cheddar'],
  ...
  {
    id: 'pnr_broccoli_cheddar_soup_cup',
    chainId: 'panera',
    category: 'Soups',
    name: 'Broccoli Cheddar Soup (Cup)',
    aliases: ['broccoli cheddar soup', 'broccoli cheddar', 'broccoli cheese soup', 'cup of broccoli cheddar', 'small broccoli cheddar'],
    serving: 'per cup',
    nutrition: { calories: 280, totalFat: 20, satFat: 13, transFat: 1.5, cholesterol: 60, sodium: 1010, carbs: 17, sugars: 6, fiber: 1, protein: 8 },
    components: wholeItemComponent('Broccoli Cheddar Soup'),
  },
  {
    ...
    aliases: ['french onion soup', 'bistro french onion', 'french onion', 'bowl of french onion', 'large french onion'],
    serving: 'per bowl (1 1/2 cups)',
  ...
  {
    id: 'pnr_french_onion_soup_cup',
    chainId: 'panera',
    category: 'Soups',
    name: 'Bistro French Onion Soup (Cup)',
    aliases: ['french onion soup', 'bistro french onion', 'french onion', 'cup of french onion', 'small french onion'],
    serving: 'per cup',
    nutrition: { calories: 200, totalFat: 10, satFat: 5, transFat: 0, cholesterol: 20, sodium: 1210, carbs: 22, sugars: 11, fiber: 1, protein: 6 },
    components: wholeItemComponent('Bistro French Onion Soup'),
  },
  {
    ...
    aliases: ['chicken noodle soup', 'homestyle chicken noodle', 'chicken noodle', 'bowl of chicken noodle', 'large chicken noodle'],
    serving: 'per bowl',
  ...
  {
    id: 'pnr_chicken_noodle_soup_cup',
    chainId: 'panera',
    category: 'Soups',
    name: 'Homestyle Chicken Noodle Soup (Cup)',
    aliases: ['chicken noodle soup', 'homestyle chicken noodle', 'chicken noodle', 'cup of chicken noodle', 'small chicken noodle'],
    serving: 'per cup',
    nutrition: { calories: 120, totalFat: 3, satFat: 1, transFat: 0, cholesterol: 35, sodium: 1050, carbs: 14, sugars: 2, fiber: 0, protein: 10 },
    components: wholeItemComponent('Homestyle Chicken Noodle Soup'),
  },
  {
